...
def find_shortest_paths(graph, start_node):
    ...
    while priority_queue:
        ...
        for neighbor, weight in graph[current_node]:
            ...
            # SUBTLE BUG: Using <= instead of < allows unnecessary updates and heap insertions
            # for paths of exactly equal length, causing wasted computation and non-deterministic path tracking.
